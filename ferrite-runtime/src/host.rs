...
use crate::adapter::{ModelAdapter, TokenizerAdapter, wit_to_ferrite_config};
use crate::ferrite::inference::inference::{
    GenerationConfig as WitGenConfig,
    Host as InferenceHost,
    HostModel,
    Model as WitModel,
};
use crate::ferrite::inference::tokenizer::Host as TokenizerHost;
